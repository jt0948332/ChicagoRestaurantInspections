...
return baseUrl;
  ...
  for (var i = 0; i < response.length; i++) {
    ...
    //popup variables
    var popup = "Name: "+response[i].DBA  +"<br>Status: "+ response[i].success + " <br>Inspection: "+response[i].Inspection + response[i].street +"<br>Year: "+ year
    // console.log(popup)
...
// };
  ...
  L.control.layers(streets, y2017).addTo(myMap);
